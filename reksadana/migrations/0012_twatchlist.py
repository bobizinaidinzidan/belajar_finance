...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('reksadana', '0011_delete_twatchlist'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_reksadana', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='reksadana.treksadana')),
            ],
            options={
